...
from datahub.metadata.schema_classes import OwnershipClass, OwnerClass, DomainsClass
...
filters: List[SearchFilterRule] = [
    {"field": "domains", "condition": "EQUAL", "values": ["urn:li:domain:Ads"]},
    {"field": "owners", "condition": "EXISTS", "negated": False},
]
...
urns: Iterable[str] = graph.get_urns_by_filter(
    query="*", entity_types=["dataset"], batch_size=1000, extraFilters=filters
)
